...
export default function EmpresaDetalhe() {
  ...
  // Determina campos conforme tipo + toggle sem movimento
  const ehProLaboreTemporarioSemMov = empresa.temProLabore && !empresa.temFuncionarios && semMovimentoMes;
  ...
  const campos = empresa.temFuncionarios ? camposFuncionarios
    : ehProLaboreTemporarioSemMov ? camposSemMov
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex gap-1.5 mt-2 flex-wrap">
              ...
              {ehProLaboreTemporarioSemMov && <span className="pill pill-amber">Sem movimento este mês</span>}
          ...
          <div className="card mb-4">
            <div className="card-header">
              ...
              <div className="flex items-center gap-3">
                {/* Toggle sem movimento — só aparece para pró-labore */}
                {empresa.temProLabore && !empresa.temFuncionarios && (
                  <button
                    ...
                    <span>{semMovimentoMes ? '⚠ Sem movimento este mês' : 'Enviar sem movimento?'}</span>
                  </button>
                )}
